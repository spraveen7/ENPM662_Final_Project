...
def vels(speed,turn):
    ...
    pub_right = rospy.Publisher('/toy_carf/controller_right_front/command', Float64, queue_size=10) # Add your topic here between ''. Eg '/my_robot/steering_controller/command'
    pub_left = rospy.Publisher('/toy_carf/controller_left_front/command', Float64, queue_size=10)
    pub_move = rospy.Publisher('/toy_carf/controller_rear/command', Float64, queue_size=10) # Add your topic for move here '' Eg '/my_robot/longitudinal_controller/command'
